package mhalo.kafka.consumer.config;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public DefaultErrorHandler errorHandler() {
        BackOff fixedBackOff = new FixedBackOff(kafkaConsumerConfigData.getRetryBackoffMs(), kafkaConsumerConfigData.getRetryCount());
