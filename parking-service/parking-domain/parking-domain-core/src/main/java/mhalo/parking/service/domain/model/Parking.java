...
public class Parking extends AggregateRoot<UUID> {
    ...
    public void stopParking(Instant stoppedAt, Money closingFee) {
        ...
        boolean isRefundable = !this.startingFee.equals(closingFee);
        this.parkingStatus = isRefundable ? ParkingStatus.STOP_PENDING : ParkingStatus.STOPPED;
    }
    ...
    public Builder toBuilder() {
        ...
        builder.zoneId = this.getZoneId();
        builder.trackingId = this.getTrackingId();
        builder.licensePlateNumber = this.getLicensePlateNumber();
        builder.startingFee = this.getStartingFee();
        builder.startedAt = this.getStartedAt();
        builder.stoppedAt = this.getStoppedAt();
        builder.closingFee = this.getClosingFee();
        builder.parkingStatus = this.getParkingStatus();
        return builder;
    }
