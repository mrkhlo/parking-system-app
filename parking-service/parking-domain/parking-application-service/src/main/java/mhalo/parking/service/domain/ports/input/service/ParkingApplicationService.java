...
public interface ParkingApplicationService {
    ...
    void approveParkingCreation(PaymentDebitEvent paymentDebitEvent);
    void declineParkingCreation(PaymentDebitEvent paymentDebitEvent);
    void confirmParkingStopping(PaymentRefundEvent event);
}
