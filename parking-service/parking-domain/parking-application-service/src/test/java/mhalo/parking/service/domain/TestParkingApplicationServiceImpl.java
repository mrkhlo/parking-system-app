...
import mhalo.parking.service.domain.exception.*;
...
class TestParkingApplicationServiceImpl {
    ...
    class ApproveParkingCreation {
        ...
        void should_ThrowParkingNotFoundException_When_ParkingNotFoundInDb() {
            ...
            //when
            Executable executable = () -> underTest.approveParkingCreation(paymentDebitEvent);
        ...
        void should_DoNothingAndReturn_When_AlreadyApproved() {
            ...
            //when
            underTest.approveParkingCreation(paymentDebitEvent);
    ...
    class DeclineParkingCreation {
        ...
        void should_ThrowParkingNotFoundException_When_ParkingNotFoundInDb() {
            ...
            //when
            Executable executable = () -> underTest.declineParkingCreation(paymentDebitEvent);
        ...
        void should_DoNothingAndReturn_When_AlreadyDeclined() {
            ...
            //when
            underTest.declineParkingCreation(paymentDebitEvent);
    ...
    class ConfirmParkingStopping {
        ...
        void should_ThrowParkingNotFoundException_When_ParkingNotFoundInDb() {
            ...
            //when
            Executable executable = () -> underTest.confirmParkingStopping(paymentRefundEvent);
        ...
        void should_DoNothingAndReturn_When_AlreadyStopped() {
            ...
            //when
            underTest.confirmParkingStopping(paymentRefundEvent);
