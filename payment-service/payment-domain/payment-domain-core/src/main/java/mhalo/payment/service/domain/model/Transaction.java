...
public class Transaction extends BaseEntity<UUID> {
    ...
    public Builder toBuilder() {
        ...
        builder.providerTransactionId = this.getProviderTransactionId();
        builder.amount = this.getAmount();
        builder.transactionType = this.getTransactionType();
        builder.transactionStatus = this.getTransactionStatus();
        builder.executedAt = this.getExecutedAt();
        return builder;
    }
