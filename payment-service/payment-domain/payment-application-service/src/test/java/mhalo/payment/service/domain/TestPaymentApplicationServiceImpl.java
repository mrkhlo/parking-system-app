...
public class TestPaymentApplicationServiceImpl {
    ...
    @InjectMocks
    private PaymentApplicationServiceImpl underTest;
    ...
    class PayParking {
        ...
        void should_DoNothingAndReturn_When_PaymentAlreadyCreated() {
            ...
            //when
            underTest.payParking(parkingCreatedEvent);
        ...
        void should_PersistPaymentWithEventAndChargeCustomer_When_ChargeCustomerSuccess() {
            ...
            Optional<Transaction> debitSuccessTransactionOpt = savedPaymentArg.getDebitSuccessTransaction();
    ...
    class Refund {
        ...
        void should_ThrowPaymentNotFoundException_When_NotFoundInDbByParkingId() {
            ...
            //when
            Executable executable = () -> underTest.refundParkingFeeDiff(parkingStoppedEvent);
        ...
        void should_DoNothingAndReturn_When_ParkingAlreadyRefunded() {
            ...
            //when
            underTest.refundParkingFeeDiff(parkingStoppedEvent);
        ...
        void should_PersistUpdatedPayment_When_RefundedNoop() {
            //given
            Payment loadedPayment = creatRandomDebitedPayment().build();
            Money startingFee = loadedPayment.getDebitSuccessTransaction().get().getAmount();
